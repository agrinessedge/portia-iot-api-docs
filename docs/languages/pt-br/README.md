...
###    1.2. Dimension  (portia:dimension)
...
###    1.1.2. Config  (portia:config)
 
Em desenvolvimento.


#   2. Portia Package - Dimension (v0.1)

##  2.1 Tipos de Pacote Portia
...
##  2.2 Definições compartilhadas entre pacotes

### 2.2.1. Códigos de Unidades de Medida 
...
### 2.2.2. Códigos de Coisas/Dispositivos
